...
const Policies = ({ propertyPolicies, cancellationPolicy }) => {
  ...
  return (
    <div className="flex flex-col gap-4 w-full min-w-min text-sm">
      <div
        className={`sm:mb-4 rounded-md bg-[#E8F7FF]
       `}
      >
        <div
          className={`p-4   font-bold font-roboto text-base flex items-center justify-between`}
        >
          Property Policy
          <button
        ...
        {policies && (
          <div className=" p-2  sm:p-4 whitespace-pre-line font-roboto text-gray-500 text-[13px]">
      ...
      <div className="sm:mb-4 rounded-md bg-[#E8F7FF]">
        <div
          className={`p-4   font-bold font-roboto text-base flex items-center justify-between`}
        >
          Cancellation Policy
